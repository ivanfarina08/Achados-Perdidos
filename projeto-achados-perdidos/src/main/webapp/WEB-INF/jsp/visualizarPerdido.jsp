...
<head>
    ...
    <title>Visualizar Perdido</title>
</head>
    ...
    <div class="perfil-fonte">
        ...
        <div class="container col-7 espaco-cima-grande">
            ...
            <div class="row titulo-pag">
                <h1 class="text-center">Visualizar Perdido</h1>
            </div>
            ...
            <form class="row g-3 espaco-cima" action="#" style="margin-bottom: 50px;">
                ...
                <div class="col-md-2">
                    ...
                    <a href="/editarPerdido?idPerdido=<c:out value="${value.id}"/>" class="btn btn-warning form-control">Alterar</a>
                </div>

                <div class="col-md-2">
                    <label class="form-label"></label>
                    <a href="/excluirPerdido?idPerdido=<c:out value="${value.id}"/>" class="btn btn-danger form-control">Excluir</a>
                </div>
