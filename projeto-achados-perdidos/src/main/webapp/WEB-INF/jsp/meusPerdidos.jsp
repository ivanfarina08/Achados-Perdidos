                ...
                <div class="">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12" style="margin-bottom: 20px;">
                            <a href="/cadastroPerdido" class="form-control btn btn-outline-success" style="font-weight: bold; font-size: 12pt;">Cadastrar novo perdido</a>
                        </div>

                        <c:forEach items="${perdidos}" var="value">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9" style="padding: auto;">
                                        ...
                                        <div class="card-body text-dark"> 
                                            <a href="/visualizarPerdido?idPerdido=<c:out value="${value.id}"/>" class="btn btn-primary">Ver mais</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
